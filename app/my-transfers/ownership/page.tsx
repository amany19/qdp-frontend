...
export default function OwnershipTransferPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!info.fullName.trim() || !info.phone.trim() || !info.email.trim() || !info.qatarId.trim()) {
      setError('يرجى تعبئة جميع بيانات المالك الجديد');
      return;
    }
    ...
    setSubmitting(true);
    try {
      await transferService.createOwnershipTransfer(info, reason.trim());
    ...
    <div className="min-h-screen bg-gray-50 pb-24" dir="rtl">
      ...
      <div className="px-4 py-6 max-w-lg mx-auto">
        <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-100 p-5 space-y-4">
          <p className="text-sm text-gray-600">بيانات المالك الجديد بعد بيع الوحدة (نقل الملكية)</p>
          <div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              placeholder="تم بيع الوحدة للمالك الجديد..."
              dir="rtl"
            />
          </div>
